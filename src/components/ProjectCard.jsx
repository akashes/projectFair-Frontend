...
function ProjectCard({projectCard,profile}) {
 ...
 <>
 {
  !profile ? <> <MDBCard  onClick={handleShow} style={{maxHeight:"300px",width:'100%'}}>
...
</Modal></> : <> <MDBCard  onClick={handleShow} style={{maxHeight:"300px",width:'100%'}}>
    <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
      <MDBCardImage src={projectCard?`${baseUrl}/uploads/${projectCard?.projectImage}`:"null"} fluid alt='...' />
      <a>
        <div className='mask' style={{ backgroundColor: 'rgba(251, 251, 251, 0.15)' }}></div>
